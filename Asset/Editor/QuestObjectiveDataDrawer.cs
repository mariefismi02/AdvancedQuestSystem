...
namespace mariefismi02.Quest.Asset.Editor
{
    ...
    [CustomPropertyDrawer(typeof(QuestObjectiveData), true)]
    public class QuestObjectiveDataDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // get all objectives types with correct generic parameter
            var types = QuestEditorCache.ObjectiveTypes;
            ...
            int newIndex = EditorGUI.Popup(dropdownRect, "Objective Type", index, typeNames);
